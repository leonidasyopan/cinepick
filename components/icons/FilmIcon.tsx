...
export const FilmIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 128 128" xmlSpace="preserve" className={className}>
    <g>
      ...
      <path style={{ opacity: 0.4, fill: '#E6E6E6' }} d="M67,33c0-1.657-1.344-3-3-3s-3,1.343-3,3L9.21,97.09   C20.423,115.616,40.765,128,64,128c25.043,0,46.713-14.395,57.227-35.352L67,33z" />
      <path style={{ opacity: 0.3, fill: '#F5F5F5' }} d="M64,28c0,1-4,5-5,5c1,0,5,4,5,5c0-1,4-5,5-5   C68,33,64,29,64,28z" />
      <path style={{ opacity: 0.3, fill: '#F5F5F5' }} d="M60.465,29.464c0.707,0.708,0.707,6.364,0,7.071   c0.707-0.707,6.363-0.707,7.07,0c-0.707-0.707-0.707-6.364,0-7.071C66.828,30.172,61.172,30.172,60.465,29.464z" />
    </g>
  </svg>
);