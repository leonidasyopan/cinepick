...
export const getMovieRecommendation = async (
    ...
    const prompt = `
        ...
        - Desired Genre/Theme Refinements: The user has selected the following characteristics: ${answers.refinements.join(', ')}. Use these to narrow down the perfect genre and movie.
